    ...
    messages: [
      {
        ...
        content: [
          ...
          "Each reason/caution should be a clean, human line that would still make sense on the website by itself.",
          "Do not mention raw metric names, ratios, percentages, or exact indicator values in reasons/cautions unless absolutely necessary.",
